    ...
    execute(message, args) {
        ...
        const rulesEmbed2 = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                { name: 'Rule 8', value: 'All error messages must be in **English**. This is the primary language of our server. We will *not* help if you post an error message in another language.' },
                { name: 'Rule 9', value: `Please wait one hour before pinging a language role with your question. If you are found to be pinging language roles too frequently you will be muted in our server. We do not want to have to mute people. This is to prevent people from spam pinging our users.`}
            )
        ...
        if (message.member.roles.cache.has('780941276602302523') || message.member.roles.cache.has('718253309101867008')) {
            ...
            message.channel.send({ embeds: [welcomeEmbed, rulesEmbed1, rulesEmbed2, formatEmbed, accessEmbed] });
        } else {
