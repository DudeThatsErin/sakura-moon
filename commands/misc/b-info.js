...
module.exports = {
    ...
    async execute(message, args) {
        ...
        let embed = new Discord.MessageEmbed()
            ...
            .addFields(
                {name: 'Invite someone to my server!', value: 'https://discord.gg/tT3VEW8AYF'},
                {name: 'Invite me to your server!', value: 'https://discord.com/api/oauth2/authorize?client_id=791803587432677427&permissions=8&scope=bot'},
                {name: 'Release Date:', value: '6 June 2021'},
                {name: 'Bot Type/Category', value: 'Utility/Miscellaneous'},
                {name: 'Developer:', value: 'Erin Skidds'},
                {name: 'Want to support me?', value: 'https://www.patreon.com/SakuraMoon'}
            )
            .setTimestamp()
