    ...
    async execute(message, args, client) {
        ...
        if (message.author.id == "455926927371534346") {
            ...
            let embed9 = new Discord.MessageEmbed()
                ...
                .setDescription('Great question! The suggestions system is a system that gives your server the ability to track suggestions as well as notify the authors of suggestions of the suggestion that they may have.');
            message.channel.send(embed9);

            let embed10 = new Discord.MessageEmbed()
                .setColor('#415BCE')
                .setTitle('Are there any future commands or systems in the works?')
                .setDescription('I am slowly working on an audit log system that will display messages or embeds for each update on a server. This will be locked behind a patreon membership because of the amount of work that goes into creating something like this. Other than that, nothing else is in the works. If you would like to suggest something run the \`++suggestions\` command.');
